...
const download = {
   ...
   */
  _doDownload: function(context, resource) {
      ...
      https.get(url, (response) => {
        ...
        file.on("finish", () => {
          file.close(() => {
            ...
            this._extract(filePath, folderPath)
            .then((extractedDir) => {
   ...
   */
  _determineLatestVersion: function(callback) {
    const options = {
   ...
   */
  _extract: async function(filePath, targetDirectory) {
    await tar.x({ file: filePath, C: targetDirectory })
